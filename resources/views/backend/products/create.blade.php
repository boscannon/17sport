                    ...
                    <div class="tab-pane active" id="btabs-static-home" role="tabpanel">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" required name="yahoo_id" class="form-control" placeholder="{{ __("backend.$routeNameData.yahoo_id") }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label>{{ __("backend.$routeNameData.momo_id") }}<span class="text-danger">*</span></label>
                                <input type="text" required name="momo_id" class="form-control" placeholder="{{ __("backend.$routeNameData.momo_id") }}">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" required name="specification" class="form-control" placeholder="{{ __("backend.$routeNameData.specification") }}">
                            </div>                                                        
                            <div class="form-group col-md-6">
                                <label>{{ __("backend.$routeNameData.unit") }}</label>
                                <input type="date" name="unit" class="form-control" placeholder="{{ __("backend.$routeNameData.unit") }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label>{{ __("backend.$routeNameData.type") }}</label>
                                <input type="date" name="type" class="form-control" placeholder="{{ __("backend.$routeNameData.type") }}">
                            </div>
                            <div class="form-group col-md-6">
