                ...
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="btabs-static-home" role="tabpanel">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <label>{{ __("backend.$routeNameData.sex") }}<span class="text-danger">*</span></label>
                                <select class="form-control" required name="sex" data-placeholder="{{ __('please_choose') }}">
                                    @foreach(__("backend.$routeNameData.gender") as $item)
                                        <option value="{{ $item }}" {{ $item == $data->sex ? 'selected' : '' }}>{{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-md-12">
